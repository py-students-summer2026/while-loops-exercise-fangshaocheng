"""
99 Bottles of Beer - while loop with accumulator version.

Sings the song "99 Bottles of Beer on the Wall" using a while loop that is
controlled by an accumulator variable that counts the bottles down.
"""
...
def sing(num_bottles):
    ...
    loop controlled by an accumulator variable.
